...
The Laplace transform is one of the most useful and commonly used continuous integral transforms used in fields such as differential equations. It is defined as the following:
...
The true value is :math:`0.54564136...`. 
...
The true value is :math:`0.34135092...`.
