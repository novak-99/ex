...
**Parameters**
    ...
    .. cpp:var:: const Complex& a
        ...
        Lower integration bound. Use :code:`NINF` from :code:`<Constants.hpp>` for :math:`-\infty`.

    .. cpp:var:: const Complex& b

        Upper integration bound. Use :code:`INF` from :code:`<Constants.hpp>` for :math:`\infty`.
