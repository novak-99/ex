...
Undefined elements :math:`X[i]` and :math:`Y[j]` are simply set to :math:`0`. The implementation is made to be of order :math:`O(n\log n)` by using the convolution theorem [2]_. Namely:
